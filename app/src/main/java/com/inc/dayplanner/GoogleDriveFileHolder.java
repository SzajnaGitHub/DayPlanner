...
import com.inc.dayplanner.tasks.EditDriveFileAsyncTask;
...
public class GoogleDriveFileHolder extends BaseDriveActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.google_drive_file_holder);
...
//    }
 ...
 //       mSaveButton.setEnabled(true);
  ...
  //      mTitleEditText.setText(mMetadata.getTitle());
        try {
            String contents = ReadFile.readFromInputStream(mDriveContents.getInputStream());
